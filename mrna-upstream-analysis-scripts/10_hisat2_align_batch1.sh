...
# Align batch 1 reads with HISAT2
# Batch 1 libraries are treated as unstranded

REF_DIR="./ref"
CLEAN_DIR="./results/02_fastp/batch1"
OUT_DIR="./results/06_align_batch1"
LOG_DIR="./logs/align_batch1"
THREADS=16
...
echo "Done: HISAT2 alignment for batch1"
